package com.plan2.example_rest_api.ParkSDK.CustomLayout;

/**
 * Created by dev01 on 2017-02-13.
 */
...
public class DottedLine extends View {
    ...
    private void init() {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.M) {
            mPaint.setColor(res.getColor(R.color.divider_color, null));
        } else {
            mPaint.setColor(res.getColor(R.color.divider_color));
        }
